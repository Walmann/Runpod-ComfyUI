...
menu_function() {
    ...
    echo "4) ReActor Models"
    echo "5) Flux Kontext Dev"
    ...
    case $choice in
        ...
        2)
            ...
            download_models "loras/WAN2.2Animate" "https://huggingface.co/Kijai/WanVideo_comfy/resolve/main/WanAnimate_relight_lora_fp16.safetensors"
